...
func (r *TodoItemPostgres) GetAll(userId, listId int) ([]todos.TodoItem, error) {
...
func (r *TodoItemPostgres) GetById(userId, itemId int) (todos.TodoItem, error) {
...
func (r *TodoItemPostgres) Update(userId, itemId int, input todos.UpdateItemInput) error {
